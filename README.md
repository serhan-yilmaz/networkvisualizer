...
<em>Effortlessly create visually appealing network figures with customizable node/edge properties and seamless support for heterogeneous graphs with multiple node types. </em>
